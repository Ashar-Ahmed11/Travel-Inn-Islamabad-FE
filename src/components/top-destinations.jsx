      ...
      <div className='pb-3'>
        ...
        <div className="row">
          <div className="col-md-6 col-12">
            ...
            >
              <img src={`https://res.cloudinary.com/jvwuwauz/image/fetch/f_webp/q_60/https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0d/d5/1c/94/passu-valley-hunza-valley.jpg?w=800&h=-1&s=1`} style={{ height: "250px", objectFit: "cover" }} class="card-img-top rounded-4" alt="..." />
          ...
          <div className="col-md-6 col-12">
            ...
            // style={{ borderColor: "#ffd054" }}
            >
              <img src={`https://res.cloudinary.com/jvwuwauz/image/fetch/f_webp/q_60/https://pyaraskardu.com/wp-content/uploads/2022/11/naran-kaghan-velley-960x636.jpg`} style={{ height: "250px", objectFit: "cover" }} class="card-img-top rounded-4" alt="..." />
          ...
          <div className="col-md-6 col-12">
            ...
            // style={{ borderColor: "#ffd054" }}
            >
              <img src={`https://res.cloudinary.com/jvwuwauz/image/fetch/f_webp/q_60/https://www.pakvoyager.com/uploads/0000/47/2023/05/09/untitled-design-2023-05-09t154820658.png`} style={{ height: "250px", objectFit: "cover" }} class="card-img-top rounded-4" alt="..." />
          ...
          <div className="col-md-6 col-12">
            ...
            // style={{ borderColor: "#ffd054" }}
            >
              <img src={`https://res.cloudinary.com/jvwuwauz/image/fetch/f_webp/q_60/https://www.blizin.com/public/images/uploads/tourpackage/6-days-5-nights-standard-tour-package-to-swat-valley-TP-27-1594898843.jpg`} style={{ height: "250px", objectFit: "cover" }} class="card-img-top rounded-4" alt="..." />
          ...
          <div className="col-md-6 col-12">
            ...
            // style={{ borderColor: "#ffd054" }}
            >
              <img src={`https://res.cloudinary.com/jvwuwauz/image/fetch/f_webp/q_60/https://flypakistan.pk/assets/img/attractions/Ayubia.png`} style={{ height: "250px", objectFit: "cover" }} class="card-img-top rounded-4" alt="..." />
          ...
          <div className="col-md-6 col-12">
            ...
            // style={{ borderColor: "#ffd054" }}
            >
              <img src={`https://res.cloudinary.com/jvwuwauz/image/fetch/f_webp/q_60/https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0a/7a/43/5b/gurez-valley-kel-to-taobat.jpg?w=1200&h=-1&s=1`} style={{ height: "250px", objectFit: "cover" }} class="card-img-top rounded-4" alt="..." />
          ...
          <div className="col-md-6 col-12">
            ...
            // style={{ borderColor: "#ffd054" }}
            >
              <img src={`https://res.cloudinary.com/jvwuwauz/image/fetch/f_webp/q_60/https://flypakistan.pk/assets/img/attractions/Naran%20Kaghan.jpg`} style={{ height: "250px", objectFit: "cover" }} class="card-img-top rounded-4" alt="..." />
