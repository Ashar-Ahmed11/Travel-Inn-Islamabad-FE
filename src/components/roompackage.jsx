...
const RoomPackage = ({ theArr }) => {
    ...
    <Transformation quality="60" />
                ...
                <p>From <h2 style={{ fontWeight: "bold", display: "contents" }} class="h4">{`Rs.${anotherObj.name=="Standard Package"?"7500":anotherObj.name=="Deluxe Package"?"8500":anotherObj.name=="Executive Package"?"9500":""}`}</h2>+Tax</p>
                                
                            </div>
                            <h2 style={{ color: '#ffd054' }} class="card-title h5 my-3 py-2">Overview</h2>
                            <p>{anotherObj.description01}</p>
                            <p>{anotherObj.description02}</p>
                            <h2 style={{ color: '#ffd054' }} class="card-title h5 my-3 py-2">Amenities and Services</h2>
                        ...
                        <div className="col-md-6 col-12 my-4">
                            <div className="px-2">
                                    ...
                                    <div className="w-100 justify-content-between  d-flex col-md-5 py-2 ">
                                        ...
                                        <div className="d-flex w-100 justify-content-between align-items-center">
                                            <div className='d-flex align-center'>
                                                <i style={{ fontSize: '30px', color: '#ffd054' }} class="fa fa-phone-square px-2" aria-hidden="true"></i>
                                                <span>Contact Us </span>
                                            </div>
                                            <div className="">
                                                <span><b><a style={{ textDecoration: 'none', color: '#ffd054' }} href={`tel:${siteData.phone}`}>{siteData.phone}</a></b></span>
                                            </div>
                                        </div>
                                ...
                                <h2 style={{ color: '#ffd054' }} class="card-title h5 my-3 py-2">Room Location</h2>
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3318.443219284081!2d73.07200717479874!3d33.723353435026574!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38dfbfa226943bbb%3A0xa45604d0605e47ea!2sTravel%20Inn%20Islamabad%20F6!5e0!3m2!1sen!2s!4v1742234440292!5m2!1sen!2s" height="300" style={{ border: 0, width: "100%" }} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                <h2 style={{ color: '#ffd054' }} class="card-title h5 my-3 pt-2">Have Any Questions?</h2>
                                ...
                                <p style={{ color: 'black' }} class=" my-3 ">
                                    ...
                                    <a style={{ color: "#ffd054", textDecoration: "none" }} href={`tel:${siteData.phone}`}>{siteData.phone}    </a>                       </p>
                                <p style={{ color: 'black' }} class=" my-3">
                                    <i style={{ fontSize: '30px', color: '#ffd054' }} class="fa fa-envelope px-2" aria-hidden="true"></i>

                                    <a style={{ color: "#ffd054", textDecoration: "none" }} href={`mailto:${siteData.email}`}>{siteData.email}                 </a>        </p>
