...
const RoomCarousal = ({upackage,image}) => {
    ...
    return (
        ...
        <div>
            <div id="carouselExampleCaptions" class="carousel slide">
                ...
                <div style={{paddingBottom:window.innerWidth>992?"32%":"70%"}} class="carousel-inner position-relative">
                    <div style={{top:"0",backgroundColor:'black'}} class="h-100 carousel-item active position-absolute">
                   
                        <img src={`https://res.cloudinary.com/jvwuwauz/image/fetch/f_webp/q_60/${image}`} style={{top:'0px',opacity:0.6,objectFit:'cover'}} class="h-100 d-block w-100 " alt="This interactive picture describes our office environment" />
                        <div style={{ top: '0px', bottom: '0px', right: '0px', left: '0px' }} class="carousel-caption h-100 w-100 justify-content-center d-flex align-items-center flex-column">
                            ...
                            <p className='display-1 p pb-5' style={{fontFamily: 'Montserrat',fontWeight:"bolder",opacity:1}} >{upackage}</p>
